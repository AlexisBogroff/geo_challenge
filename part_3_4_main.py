...
# Load data
data_t0 = load_data(stng.PATH_DATA, date_max=stng.DATE_MIN)
data_t1 = load_data(stng.PATH_DATA, date_min=stng.DATE_MIN,
...
detector.detect_static_objects(n_periods_min=20, smooth=5)
